  ...
  >
    ...
    <div style={videoStyles.videoWrapper}>
      <video style={videoStyles.videoElement} controls>
        ...
        <source
          src="/WhatsApp Video 2025-12-03 at 8.53.33 PM.mp4"
          type="video/mp4"
        />
        {t("videoNotSupported", {
  ...
  <div className="notification-popup">
    <div className="notification-header">
      ...
      <button
        ...
        aria-label={t("notification.closeLabel")}
      >
        ×
      </button>
    </div>
    ...
    <div style={{ marginTop: 12 }}>
      {!isLoggedIn ? (
        ...
        >
          {t("notification.loginPrompt")}
        </button>
      ) : (
        <div style={{ color: "#4b5563" }}>
          <strong>{t("notification.detailsTitle")}</strong>
          <div>{t("notification.detailsMessage")}</div>
        </div>
      )}
        </div>
       </div>
